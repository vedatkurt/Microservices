...
namespace FreeCourse.IdentityServer.Services
{
    public class TokenExchangeExtensionGrantValidator : IExtensionGrantValidator
    {
        ...
        public async Task ValidateAsync(ExtensionGrantValidationContext context)
        {
            ...
            // Token payload icindeki kullaniciclaim tutuldugu sub bilgisi alinir
            ...
            // Yeni token uretilir ve geri dondurulur.
            context.Result = new GrantValidationResult(
                subjectClaim.Value, // Kullanicinin Idsi
                "access_token",
                tokenValidateResult.Claims, // Yeni uretilecek Token icinde olacak Claims
                "");
        }
    }
}
